export const CONTINENT_MAP: Record<string, { continent: string, subcontinent: string }> = {
  // --- AFRICA ---
  ...
  "Bir Tawil": { continent: "Africa", subcontinent: "Northern Africa" },
  "Botswana": { continent: "Africa", subcontinent: "Southern Africa" },
  "British Indian Ocean Territory": { continent: "Africa", subcontinent: "Eastern Africa" },
  ...
  "Saint Helena": { continent: "Africa", subcontinent: "Western Africa" },
  "Sao Tome and Principe": { continent: "Africa", subcontinent: "Middle Africa" },
  "S\u00e3o Tom\u00e9 and Principe": { continent: "Africa", subcontinent: "Middle Africa" },
  ...
  "Somaliland": { continent: "Africa", subcontinent: "Eastern Africa" },
  ...
  "United Republic of Tanzania": { continent: "Africa", subcontinent: "Eastern Africa" },
  ...
  "Western Sahara": { continent: "Africa", subcontinent: "Northern Africa" },
  ...
  "Baykonur Cosmodrome": { continent: "Asia", subcontinent: "Central Asia" },
  ...
  "Cyprus No Mans Area": { continent: "Asia", subcontinent: "Western Asia" },
  "Dhekelia Sovereign Base Area": { continent: "Asia", subcontinent: "Western Asia" },
  "Akrotiri Sovereign Base Area": { continent: "Asia", subcontinent: "Western Asia" },
  "East Timor": { continent: "Asia", subcontinent: "South-Eastern Asia" },
  "Georgia": { continent: "Asia", subcontinent: "Western Asia" },
  "Hong Kong S.A.R.": { continent: "Asia", subcontinent: "Eastern Asia" },
  "India": { continent: "Asia", subcontinent: "Southern Asia" },
  "Indonesia": { continent: "Asia", subcontinent: "South-Eastern Asia" },
  "Iran": { continent: "Asia", subcontinent: "Western Asia" },
  ...
  "Macao S.A.R": { continent: "Asia", subcontinent: "Eastern Asia" },
  ...
  "Northern Cyprus": { continent: "Asia", subcontinent: "Western Asia" },
  ...
  "Scarborough Reef": { continent: "Asia", subcontinent: "South-Eastern Asia" },
  "Siachen Glacier": { continent: "Asia", subcontinent: "Southern Asia" },
  "Singapore": { continent: "Asia", subcontinent: "South-Eastern Asia" },
  "South Korea": { continent: "Asia", subcontinent: "Eastern Asia" },
  "Spratly Islands": { continent: "Asia", subcontinent: "South-Eastern Asia" },
  ...
  "Aland": { continent: "Europe", subcontinent: "Northern Europe" },
  ...
  "Czechia": { continent: "Europe", subcontinent: "Eastern Europe" },
  ...
  "Gibraltar": { continent: "Europe", subcontinent: "Southern Europe" },
  "Greece": { continent: "Europe", subcontinent: "Southern Europe" },
  "Guernsey": { continent: "Europe", subcontinent: "Northern Europe" },
  ...
  "Isle of Man": { continent: "Europe", subcontinent: "Northern Europe" },
  ...
  "Russia": { continent: "Europe", subcontinent: "Eastern Europe" },
  "San Marino": { continent: "Europe", subcontinent: "Southern Europe" },
  "Republic of Serbia": { continent: "Europe", subcontinent: "Southern Europe" },
  ...
  "Vatican": { continent: "Europe", subcontinent: "Southern Europe" },
  ...
  "Bajo Nuevo Bank (Petrel Is.)": { continent: "North America", subcontinent: "Caribbean" },
  ...
  "Clipperton Island": { continent: "North America", subcontinent: "Central America" },
  ...
  "Saint Pierre and Miquelon": { continent: "North America", subcontinent: "Northern America" },
  "Saint Vincent and the Grenadines": { continent: "North America", subcontinent: "Caribbean" },
  "Serranilla Bank": { continent: "North America", subcontinent: "Caribbean" },
  ...
  "United States Minor Outlying Islands": { continent: "North America", subcontinent: "Caribbean" },
  "United States of America": { continent: "North America", subcontinent: "Northern America" },
  "United States Virgin Islands": { continent: "North America", subcontinent: "Caribbean" },
  "US Naval Base Guantanamo Bay": { continent: "North America", subcontinent: "Caribbean" },
  ...
  "Brazilian Island": { continent: "South America", subcontinent: "South America" },
  ...
  "Falkland Islands": { continent: "South America", subcontinent: "South America" },
  ...
  "Southern Patagonian Ice Field": { continent: "South America", subcontinent: "South America" },
  ...
  "Ashmore and Cartier Islands": { continent: "Oceania", subcontinent: "Australia and New Zealand" },
  "Australia": { continent: "Oceania", subcontinent: "Australia and New Zealand" },
  "Cook Islands": { continent: "Oceania", subcontinent: "Polynesia" },
  "Coral Sea Islands": { continent: "Oceania", subcontinent: "Melanesia" },
  ...
  "Indian Ocean Territories": { continent: "Oceania", subcontinent: "Australia and New Zealand" },
  "Kiribati": { continent: "Oceania", subcontinent: "Micronesia" },
  "Marshall Islands": { continent: "Oceania", subcontinent: "Micronesia" },
  "Federated States of Micronesia": { continent: "Oceania", subcontinent: "Micronesia" },
  ...
  "Niue": { continent: "Oceania", subcontinent: "Polynesia" },
  "Norfolk Island": { continent: "Oceania", subcontinent: "Australia and New Zealand" },
  ...
  "Pitcairn Islands": { continent: "Oceania", subcontinent: "Polynesia" },
  ...
  "Wallis and Futuna": { continent: "Oceania", subcontinent: "Polynesia" },

  // --- ANTARCTICA ---
  "Antarctica": { continent: "Antarctica", subcontinent: "Antarctica" },
  "French Southern and Antarctic Lands": { continent: "Antarctica", subcontinent: "Antarctica" },
  "Heard Island and McDonald Islands": { continent: "Antarctica", subcontinent: "Antarctica" },
  "South Georgia and the Islands": { continent: "Antarctica", subcontinent: "Antarctica" }
};
...
export const CENTROIDS: Record<string, [number, number]> = {
  ...
  "Oceania": [135, -25],
  "Antarctica": [0, -80],
  "Southern Africa": [25, -20],
  "Western Africa": [-5, 15],
  "Eastern Africa": [38, 10],
  "Middle Africa": [20, 0],
  "Northern Africa": [15, 25],
  "Southern Asia": [75, 20],
  "Western Asia": [45, 25],
  "South-Eastern Asia": [115, 5],
  "Eastern Asia": [115, 35],
  "Central Asia": [65, 45],
  "Western Europe": [5, 47],
  ...
  "Northern America": [-100, 55],
  "Central America": [-90, 15],
  "Caribbean": [-75, 18],
  "Australia and New Zealand": [135, -30],
  "Melanesia": [155, -10],
  "Polynesia": [-150, -20],
  "Micronesia": [150, 10]
};
