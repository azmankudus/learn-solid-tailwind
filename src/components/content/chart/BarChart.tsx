...
export function BarChart(props: BarChartProps) {
  ...
  return (
    <Card class={`p-8 shadow-2xl animate-fade-in ${props.class || ""}`}>
      <Show when={props.title || props.subtitle}>
        <div class="mb-6">
          <Show when={props.title}>
            <h3 class="text-xl font-bold tracking-tight text-main">{props.title}</h3>
          </Show>
      ...
      <div class={`relative rounded-3xl bg-black/[0.02] dark:bg-white/[0.02] overflow-hidden ${props.height || "h-[400px]"}`}>
