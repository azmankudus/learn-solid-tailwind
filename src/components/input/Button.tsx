    ...
    >
      ...
      >
        <div class="flex items-center justify-center gap-2">
          <Show when={(local.layout === "icon-text" || local.layout === "reveal-left") && local.icon}>
            <div class={`flex items-center justify-center w-4 h-4 shrink-0 transition-all duration-500
              ${local.layout === "reveal-left" ? "-translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100" : "group-hover:scale-110"}
            `}>
              {local.icon}
            </div>
          </Show>
          ...
          <Show when={(local.layout === "text-icon" || (!local.layout && local.icon) || local.layout === "reveal-right") && local.icon}>
            <div class={`flex items-center justify-center w-4 h-4 shrink-0 transition-all duration-500
              ${local.layout === "reveal-right" ? "translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100" : "group-hover:scale-110"}
            `}>
              {local.icon}
            </div>
          </Show>
