    ...
    >
      ...
      >
        <div class={`flex items-center justify-center gap-2 transition-all duration-300 
          ${local.layout === 'reveal-right' ? 'group-hover:-translate-x-1' : ''}
          ${local.layout === 'reveal-left' ? 'group-hover:translate-x-1' : ''}
        `}>
        ...
        {/* Reveal Icon Overlay from vibe reference */}
        <Show when={(local.layout === "reveal-left" || local.layout === "reveal-right") && local.icon}>
          <div class={`absolute transition-all duration-300 ease-out opacity-0 group-hover:opacity-100 flex items-center justify-center
            ${local.layout === 'reveal-right' ? 'right-0 translate-x-full group-hover:-translate-x-3' : 'left-0 -translate-x-full group-hover:translate-x-3'}
          `}>
